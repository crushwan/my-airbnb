...
function Header({ placeholder }) {
  ...
  return (
    <header className="dark:bg-[#181818] sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-5">
      <div
        onClick={() => router.push("/")}
      ...
      <div className="flex items-center md:border-2 rounded-full py-1 md:shadow-sm">
        <input
          ...
          className="flex-grow pl-5 bg-transparent outline-none text-sm text-gray-600 dark:text-gray-300 md:placeholder-gray-600 "
          type="text"
          placeholder={
      ...
      {searchInput && (
        ...
        >
          <DateRangePicker
            className="scale-[0.70] md:scale-100 dark:text-[#181818]"
          ...
          >
            <h2 className="text-xl flex-grow font-semibold dark:text-[#181818]">
              Guests
            </h2>
            <UserIcon className="h-5 px-2 dark:text-[#181818]" />
            <input
              type="number"
              value={noOfGuests}
